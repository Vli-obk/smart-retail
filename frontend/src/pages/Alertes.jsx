        ...
        <div className="p-8 animate-fade-in space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Real-time risk assessment and AI-driven stock predictions.</p>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-black text-slate-400 uppercase tracking-widest">Live Analysis</span>
                </div>
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-12">
                        <div className="space-y-6 lg:max-w-xl">
                            ...
                            <h2 className="text-4xl font-black leading-tight tracking-tight">
                                ...
                                <span className="text-blue-500 underline decoration-blue-500/30 underline-offset-8">Critical Depletion</span> Detected
                            </h2>

                            <p className="text-slate-400 text-lg font-medium leading-relaxed italic">
                                "Our neural architecture has analyzed recent transaction velocities. Statistical models indicate imminent stock-out events for high-priority SKUs."
                            </p>

                            <div className="flex flex-wrap gap-4 pt-4">
                                <div className="bg-white/5 border border-white/10 px-6 py-4 rounded-3xl backdrop-blur-xl">
                                    <p className="text-[10px] font-black text-blue-500 uppercase tracking-widest mb-1">Target Asset</p>
                                    <p className="text-xl font-bold">Premium Couscous 1KG</p>
                                </div>
                                <div className="bg-white/5 border border-white/10 px-6 py-4 rounded-3xl backdrop-blur-xl">
                                    <p className="text-[10px] font-black text-rose-500 uppercase tracking-widest mb-1">Risk Window</p>
                                    <p className="text-xl font-bold text-rose-500">~ {prediction?.days_until_out || '4'} Days Left</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3">
                            <div className="bg-blue-600 rounded-[2rem] p-8 shadow-xl shadow-blue-600/30 transform hover:scale-[1.02] transition-transform duration-500">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] opacity-80">Urgent Protocol</span>
                                </div>
                                <h3 className="text-2xl font-black mb-4 leading-tight">Automate Restock Order?</h3>
                                <p className="text-blue-100 text-sm font-medium mb-8 leading-relaxed opacity-90">
                                    Sync with supplier API.v2 for immediate inventory replenishment.
                                </p>
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
                        <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-xl font-black text-slate-900">Inventory Watchlist</h3>
                            </div>
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Sorting by risk</span>
                        </div>
                                        ...
                                        <div className="flex items-center gap-6">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Asset ID: #00{item.id}</span>
                                                    <span className="w-1 h-1 bg-slate-200 rounded-full"></span>
                                                    <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">Priority SKU</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <div className="text-right hidden md:block">
                                                <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">Current State</p>
                                                <p className="text-lg font-black text-slate-900">{item.current_stock || 0} <span className="text-[10px]">UNITS</span></p>
                                            </div>
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 space-y-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="text-lg font-black text-slate-900 tracking-tight">System Telemetry</h3>
                        </div>
                        
                        <TelemetryRow label="Model Accuracy" value="94.2%" color="text-emerald-500" />
                        <TelemetryRow label="Data Freshness" value="Last 24h" color="text-blue-500" />
                        <TelemetryRow label="Active Sensors" value="12 Nodes" color="text-slate-900" />
                        
                        <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                            <div className="flex items-center gap-2 mb-3">
                                <Microscope size={16} className="text-indigo-500" />
                                <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.15em]">Analysis Mode</span>
                            </div>
                            <p className="text-xs font-medium text-slate-600 leading-relaxed">
                                System is currently running in "Predictive Mode". Automatic restocking is disabled by policy.
                            </p>
                        </div>
                    </div>
                </div>
